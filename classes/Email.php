...
class Email {
    ...
    <body>
        ...
        <p>Por favor confirma tu correo electrónico para que puedas comenzar a disfrutar de todos los beneficios de
            UpTask.</p>
        <a href='https://ancient-bastion-70671.herokuapp.com/confirmar?token=" . $this->token . "'><button>Verificar</button></a>
    ...
    <body>
        ...
        <a href='https://ancient-bastion-70671.herokuapp.com/reestablecer?token=" . $this->token . "'><button>Reestablecer Password</button></a>
