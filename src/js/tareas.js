// IIEF -> Proteje las variables/funciones para que no se mezclen con otras
(function() {
    ...
    function mostrarTareas() {
        ...
        arrayTareas.forEach(tarea => {
            ...
            btnEstadoTarea.ondblclick = function () {
                cambiarEstadoTarea({...tarea}); // Evita mutar las tareas
            }
    ...
    function mostrarFormulario(editar = false, tarea =  {} ) {
        ...
        // Delegation = podemos identificar un elemento y esperar a que suceda un click en él para realizar una acción
    ...
    // Consultar el Servidor para añadir una nueva tarea al proyecto actual
       async function agregarTarea(tarea) {
        ...
        try {
            const url = 'https://guarded-tundra-20607.herokuapp.com/api/tarea';
            const respuesta = await fetch(url, {
                method: 'POST',
                body: datos
            });
    ...
    async function actualizarTarea(tarea) {
        ...
        try {
            const url = 'https://guarded-tundra-20607.herokuapp.com/api/tarea/actualizar';
    ...
    async function eliminarTarea(tarea) {
        ...
        try {
            const url = 'https://guarded-tundra-20607.herokuapp.com/api/tarea/eliminar';
